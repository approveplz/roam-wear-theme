    ...
    availability.prototype = Object.assign({}, availability.prototype, {
      ...
      enableVariantOption: function (group, obj) {
        ...
        if (this.type === "dropdown") {
          if (obj.soldOut) {
            group.querySelector('option[value="' + value + '"]').disabled =
              true;
          } else {
            group.querySelector('option[value="' + value + '"]').disabled =
              false;
      ...
      CollectionSwitcher.prototype,
      {
        init: function () {
          ...
          this.config = {
            ...
            perRowMobile:
              Number(this.container.getAttribute("data-per-row")) <= 2 ? 1 : 2, // fixed to 2 at most but is 1 if mobile card is full width
          };
    ...
    FadingImages.prototype = Object.assign({}, FadingImages.prototype, {
      ...
      nextImage: function () {
        var activeImage = this.container.querySelector(
          '.fading-images__item-wrapper[data-slide-index="' +
